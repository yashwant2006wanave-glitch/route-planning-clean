...
int main(int argc, const char** argv) {
  ...
  std::cout <<   "╠══════════════════════════════════════╣\n";
  std::cout <<   "║  A*        : " << route_planner.GetDistance()          << " meters\n";
  std::cout <<   "║  Dijkstra  : " << route_planner.GetDijkstraDistance()  << " meters\n";
  std::cout <<   "║                                      ║\n";
  std::cout <<   "║  Both find the OPTIMAL path.         ║\n";
  std::cout <<   "║  A* is faster due to heuristic.      ║\n";
  std::cout <<   "╚══════════════════════════════════════╝\n\n";

  // Render A* result on map.
  Render render{model};
